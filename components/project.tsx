...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
    ...
    return (
        <motion.div
            ...
            ref={ref}
        >
            <section className="group bg-gray-100 max-w-[42rem] borderBlack overflow-hidden rounded-lg sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition group-even:pl-8">
